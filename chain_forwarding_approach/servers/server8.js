...
const options = {
    key: fs.readFileSync('../../certs/server-8-key.pem'), // Server private key
    cert: fs.readFileSync('../../certs/server-8-cert.pem'), // Server certificate
...
const serverPrivateKey = fs.readFileSync('../../keys/server-8-private-key.pem', 'utf8'); // Replace X with the server index
