...
const options = {
    key: fs.readFileSync('../../certs/server-4-key.pem'), // Server private key
    cert: fs.readFileSync('../../certs/server-4-cert.pem'), // Server certificate
...
const serverPrivateKey = fs.readFileSync('../../keys/server-4-private-key.pem', 'utf8'); // Replace X with the server index
