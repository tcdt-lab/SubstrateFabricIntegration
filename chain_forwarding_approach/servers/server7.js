...
const options = {
    key: fs.readFileSync('../../certs/server-7-key.pem'), // Server private key
    cert: fs.readFileSync('../../certs/server-7-cert.pem'), // Server certificate
...
const serverPrivateKey = fs.readFileSync('../../keys/server-7-private-key.pem', 'utf8'); // Replace X with the server index
