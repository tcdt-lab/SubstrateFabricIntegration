...
const options = {
    key: fs.readFileSync('../../certs/server-6-key.pem'),
    cert: fs.readFileSync('../../certs/server-6-cert.pem'),
...
const serverPrivateKey = fs.readFileSync('../../keys/server-6-private-key.pem', 'utf8');

// Load server's signing private key (adjusted for signing purposes)
const serverSigningPrivateKey = fs.readFileSync('/home/saeed/Desktop/substrate-contracts-node/signing-keys/server-6-private-key.pem', 'utf8');
