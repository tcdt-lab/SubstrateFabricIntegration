...
const options = {
    key: fs.readFileSync('../../certs/server-5-key.pem'),
    cert: fs.readFileSync('../../certs/server-5-cert.pem'),
...
const serverPrivateKey = fs.readFileSync('../../keys/server-5-private-key.pem', 'utf8');

// Load server's signing private key (adjusted for signing purposes)
const serverSigningPrivateKey = fs.readFileSync('/home/saeed/Desktop/substrate-contracts-node/signing-keys/server-5-private-key.pem', 'utf8');
