...
const serverSigningPrivateKey = fs.readFileSync('/home/saeed/Desktop/substrate-contracts-node/signing-keys/server-9-private-key.pem', 'utf8');
...
https.createServer(options, app).listen(3009, () => {
