...
const options = {
    key: fs.readFileSync('../../certs/server-8-key.pem'),
    cert: fs.readFileSync('../../certs/server-8-cert.pem'),
...
const serverPrivateKey = fs.readFileSync('../../keys/server-8-private-key.pem', 'utf8');

// Load server's signing private key (adjusted for signing purposes)
const serverSigningPrivateKey = fs.readFileSync('/home/saeed/Desktop/substrate-contracts-node/signing-keys/server-8-private-key.pem', 'utf8');
